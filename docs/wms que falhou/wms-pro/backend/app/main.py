...
from backend.app.api import routes_auth, routes_receiving, routes_wms, routes_tasks
...
app.include_router(routes_tasks.router, prefix=f"{settings.API_V1_STR}/wms", tags=["tasks"])
